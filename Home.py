...
st.title("Apps")
st.write("Hyphen and LuxStock open in their own apps. Comm-Pilot opens a walkthrough here — the real product is a Chrome side panel.")
...
with c1:
    ...
    st.page_link("pages/1_Hyphen_Matcher.py", label="Details")
...
with c2:
    ...
    st.page_link("pages/2_LuxStock_AI.py", label="Details")
...
with c3:
    ...
    if st.button("Open Comm-Pilot", type="primary"):
        st.switch_page("pages/3_Comm_Pilot.py")
    st.page_link("pages/3_Comm_Pilot.py", label="Open demo")
